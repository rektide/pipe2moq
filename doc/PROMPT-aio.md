...
build a rust package that uses gstreamer rust and moq-relay rust to create a tightly coupled gstreamer pipeline pursuant to the `system design` in the readme.
